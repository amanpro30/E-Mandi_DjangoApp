...
urlpatterns = [
    ...
    path('executedorder/<orderid>/',views.ExecutedOrderid.as_view()),
    path('cropproduction/<city>/',views.Cityproduction.as_view()),
    path('cropproduction1/<cropname>/',views.Cropproduction.as_view()),
    path('cropproduction/<city>/<cropname>/',views.Citycropproduction.as_view()),
]
